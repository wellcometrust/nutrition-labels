...
python nutrition_labels/grant_tagger.py --config_path configs/train_model/2021.04.04.ini
echo 'Predicting tech grants ...'
python nutrition_labels/predict.py --config_path configs/predict/2021.04.06.ini
